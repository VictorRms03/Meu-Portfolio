...
function GerarProjeto({id, titulo, descricao, imagem, link}: GerarProjetoProps) {
...
export default function ProjetosList() {
    const projetos = [
        { 
            ...
            descricao: "Trashtrack é um sistema desenvolvido para ajudar recicladores e coletores de lixo a se organizarem de " + 
        ...
        { 
            ...
            descricao: "Contrack é uma ferramenta em desenvolvimento para auxiliar na gestão de contratos da Rádio 92.1 " +
        ...
        { 
            ...
            descricao: "Tic Tac Toe: Online é um jogo online que utiliza WebSockets para comunicação com os jogadores, " +
        ...
        { 
            ...
            descricao: "UgaTeste é uma ferramenta de teste vocacional desenvolvida como TCC " +
    ...
    return (
        <div className="md:px-12 xl:px-0 w-full flex flex-col justify-center items-center gap-15 xl:gap-30 mt-16">
            {projetos.map((projeto, index) => (
                <GerarProjeto key={index} id={index} titulo={projeto.titulo} descricao={projeto.descricao} imagem={projeto.imagem} link={projeto.link} />
            ))}
        </div>
    )
}
