...
export default function Sobre() {
    return (
        ...
        <section id="sobre" className="py-12 scroll-mt-20">
            ...
            <div className=" max-w-11/12 md:max-w-9/12 mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="md:w-1/2 justify-start">
                    ...
                    <p className="mt-6 md:mt-12"> Olá! Tenho 20 anos e programo desde os 14 quando entrei para o curso técnico em informática,
                    ...
                    <p className="mt-6 md:mt-12"> Além da programação, sou uma pessoa comunicativa que gosta de conversas sobre basicamente qualquer assunto!
