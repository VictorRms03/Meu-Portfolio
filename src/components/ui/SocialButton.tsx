    ...
    if (hoverIconPath) {
        return (
            <a
                ...
                className={`group relative flex items-center justify-center rounded bg-white border-2 border-black hover:bg-black transition-all duration-300 hover:-translate-y-1 hover:scale-110 hover:shadow-lg hover:shadow-black/20 ${className ?? ""}`}
            >
                <Image
                    src={iconPath}
                    alt={altSocial}
